...
def evidence_classifier_node(state: Mapping[str, object]) -> dict[str, object | None]:
    ...
    try:
        ...
        try:
            llm_classifications = _llm_classify_evidences([ev for ev in evidences if isinstance(ev, dict)])
        ...
        for idx, ev in enumerate(evidences):
            ...
            if llm_item:
                ...
                fact_or_interpretation = str(llm_item.get("fact_or_interpretation") or "interpretation")
